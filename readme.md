I built this as a test to show JSON files as a table. I plan on expanding this project in the future where I can use it as a career mode tracker for fifa 22 since the game doesn't come with one.
